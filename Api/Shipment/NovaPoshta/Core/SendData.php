...
if(!class_exists('NovaPoshta\Core\Serializer\SerializerFactory')) 
			require(VMPATH_MY_PLUGIN_VMUPS_LIBS.DS.'lib'.DS.'NovaPoshta'.DS.'Core'.DS.'Serializer'.DS.'SerializerFactory.php'); // end if
