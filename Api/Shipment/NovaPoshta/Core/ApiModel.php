...
if(!class_exists('NovaPoshta\Models\DataContainer')) 
				require(VMPATH_MY_PLUGIN_VMUPS_LIBS.DS.'lib'.DS.'NovaPoshta'.DS.'Models'.DS.'DataContainer.php'); // end if
if(!class_exists('NovaPoshta\Core\SendData')) 
				require(VMPATH_MY_PLUGIN_VMUPS_LIBS.DS.'lib'.DS.'NovaPoshta'.DS.'Core'.DS.'SendData.php'); // end if
