 ...
 * v 1.9 Nov 2012
 * License	:	MIT License
 * @inheritDoc https://github.com/knadh/localStorageDB#localstoragedb-232
 */
!(function (_global, undefined) {
    function localStorageDB(db_name, engine) {
        ...
        function truncate(table_name) {
            console.log(  db.tables[table_name] )
        ...
        /**
         * выбрать строки в таблице по функции, возвращает идентификаторы совпадений
         * @param table_name
