...
(function (global, factory) {
    ...
    var setSourcesTemplate = function setSources(element, instance) {
        console.log(element)
        alert('element')
    };

    var setSourcesFunctions = {
        TEMPLATE: setSourcesTemplate,
        IMG: setSourcesImg,
    ...
    var managedTags = ["IMG", "IFRAME", "VIDEO", "TEMPLATE"];
