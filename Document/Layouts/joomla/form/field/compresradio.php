 ...
 * @var   string    $file         Путь к файлу от корня сайта без ведущего слеша.
 */
...
$plugin = PluginHelper::getPlugin('system', 'pro_critical');
if (empty($plugin))
{
    $disabled = 1 ;
    $value = 0 ;
...
<fieldset data-file="<?= $file  ?>" id="<?php echo $id; ?>" class="<?php echo trim($class . ' radio' . ($readonly || $disabled ? ' disabled' : '') . ($readonly ? ' readonly' : '')); ?>"
