<?php
    ...
    /**
     * Список категорий от родительской JoomShoping
     * Для получения верхнего уровня категорий
     ...
     *
     */
    class JFormFieldListjsparentcategory extends JFormFieldList
    {
         ...
         * @since 3.9
         */
        public $type = 'listjsparentcategory';
        /**
...
//            $order="name" ;
            $order="order" ;
            $ordering="asc" ;
            $tree = $cat->getSisterCategories($order, $ordering);

//            echo'<pre>';print_r( $tree );echo'</pre>'.__FILE__.' '.__LINE__ . PHP_EOL;
